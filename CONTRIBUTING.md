...
- ⭐ **Star the repo** to get notified when we open
- 📧 **Email us** at contact@quartumse.dev to express interest in Early Access
- 📄 **Watch for preprints** on arXiv (late 2025 / early 2026)
...
- ✨ **Feature requests** (especially domain-specific use cases)
- 📚 **Documentation improvements**
- 🔬 **Experimental results** on new backends or problem instances
- 🧪 **New shadow protocols** (v5+)
- 🔌 **Backend connectors** (IonQ, Rigetti, etc.)
