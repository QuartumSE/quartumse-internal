# Getting Started with QuartumSE
...
- Review [Testing](testing.md) for guidance on slow, integration, and hardware
  test markers.
- Explore the [Data Storage](data_storage.md) reference to understand the
  manifest and Parquet schemas.
