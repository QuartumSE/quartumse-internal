...
4. When preparing a public release or milestone summary, update [`CHANGELOG.md`](https://github.com/quartumse/quartumse/blob/master/CHANGELOG.md) with the scope of work that shipped before tagging.
